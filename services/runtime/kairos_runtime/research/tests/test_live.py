...
async def test_live_classify_query():
    ...
    from kairos_runtime.research.classifier import classify_query
    from kairos_runtime.research.state import Classification
...
async def test_live_grounded_search():
    ...
    from kairos_runtime.research.grounding import grounded_search
...
async def test_live_deep_research_quick():
    ...
    from kairos_runtime.research.state import ResearchReport
