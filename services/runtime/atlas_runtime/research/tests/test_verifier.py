...
from atlas_runtime.research.filesystem import VirtualFS
from atlas_runtime.research.verifier import (
    _get_wayback_url,
    check_urls_batch,
...
async def test_check_urls_batch_live_and_dead():
    ...
    with patch(
        "atlas_runtime.research.verifier._check_url_liveness",
...
async def test_wayback_fallback():
    ...
    with patch("atlas_runtime.research.verifier.httpx.AsyncClient") as MockClient:
...
async def test_verify_findings_batches_nli_per_url(monkeypatch):
    ...
    """
    from atlas_runtime.research import verifier as v
...
def test_parse_batch_verdicts():
    from atlas_runtime.research.verifier import _parse_batch_verdicts
...
async def test_check_urls_batch_uses_cache_as_liveness_signal():
    ...
    from atlas_runtime.research.cache import RunCache
