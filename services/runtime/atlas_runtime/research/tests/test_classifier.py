...
from atlas_runtime.research.classifier import (
    classify_and_brief,
    classify_query,
    write_research_brief,
)
from atlas_runtime.research.state import Classification, Domain, QueryType, ResearchBrief
...
async def test_classify_query_parses_valid_json(mock_classifier_response):
    ...
    with patch(
        "atlas_runtime.research.classifier.ChatGoogleGenerativeAI"
    ) as MockLLM:
