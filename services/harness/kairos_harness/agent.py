...
def build_agent(
    *,
    ...
    persona (the JARVIS delivery cues) on top of the normal Kairos
    ...
    # Disabled by default (`KAIROS_USE_CONTEXT_CACHE` flag in
    ...
    if prompt_cache.context_cache_enabled():
        model_name = config_get("KAIROS_MODEL_OVERRIDE") or config_get(
